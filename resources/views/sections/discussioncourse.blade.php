            	...
            	<div class="creative-b-wrap">
            		<div class="container">
	            		<div class="row">
                            ...
                            <a href="#">Discussion Board</a> <span class="diviver">&gt;</span> <a href="#">{{$module->title}} Module</a>
                             <span class="diviver">&gt;</span> <a href="#">Courses</a>
                       </div>
										...
										<div class="row">
											<div class="p-20">
												<div class="col-md-2">
													<div class="p-10">
														<div class="p-5 ">
															<a href="{{ route('frontend.course.get', $course->id) }}"> <img src="{{asset($course->img)}}" class="discussion-avatar" /> </a>
														</div>
												...
												<div class="col-md-8">
													<div class="p-10 disc-cat-title border-right">
														<h5><a href="{{route('frontend.discussion.sessions.get', $course->id)}}">{{$course->title}}</a></h5>
												...
												<div class="col-md-2">
													<div class="p-10 text-center ">
														<?php $course_posts = \App\Models\Post::whereParent_type('course')->whereParent_id($course->id)->get(); ?>
														<h5>{{ count($course_posts) }} posts</h5>
	            				  ...
	            				  <div class="post boxed-bg box-shadow border-redius discussion-post wow fadeInUp">
		                                    ...
		                                    <div class="topwrap">
		                                        ...
		                                        <div class="posttext pull-left">
		                                         ...
		                                         <input type="hidden" name="parent_type" value="module">
