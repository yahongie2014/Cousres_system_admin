	...
	<div class="col-md-12">
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-gift"></i>Create Exam
				</div>
				<div class="tools">
				...
				<form action="{{ route('admin.exams.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="duration" value="{{ old('duration') }}" class="form-control input-circle" placeholder="Enter duration">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="scq_count" value="{{ old('scq_count') }}" class="form-control input-circle" placeholder="Enter SCQ Count">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="mcq_count" value="{{ old('mcq_count') }}" class="form-control input-circle" placeholder="Enter MCQ Count">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="essay_count" value="{{ old('essay_count') }}" class="form-control input-circle" placeholder="Enter Essay Count">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="scq_mark" value="{{ old('scq_mark') }}" class="form-control input-circle" placeholder="Enter SCQ mark">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="mcq_mark" value="{{ old('mcq_mark') }}" class="form-control input-circle" placeholder="Enter MCQ mark">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="essay_mark" value="{{ old('essay_mark') }}" class="form-control input-circle" placeholder="Enter Essay mark">
