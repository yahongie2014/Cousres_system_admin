	...
	<div class="col-md-12">
		<div class="portlet box yellow">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-gift"></i>Update Courses
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<form action="{{ route('admin.courses.update', $course->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
					...
					<div class="form-body">
						<div class="form-group">
							...
							<div class="col-md-4">
								<select name="module" class="form-control input-circle">
									...
									<option value="{{ $module->id }}" {{ $module->id == $course->module_id ? 'selected': '' }}>{{ $module->title }}</option>
									@endforeach
								</select>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="title" value="{{ $course->title }}" class="form-control input-circle" placeholder="Enter title">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Enter What Learned</label>
							<div class="col-md-9">
								<textarea name="learn" class="form-control ckeditor">{{ $course->learn }}</textarea>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="start_date" value="{{ $course->start_date }}" class="form-control input-circle" placeholder="Enter Start Date">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="end_date" value="{{ $course->end_date }}" class="form-control input-circle" placeholder="Enter End Date">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="checkbox" name="status" class="make-switch" data-on-text="Active" data-off-text="Inactive" {{ $course->status == 1 ? 'checked' : '' }}>
							</div>
						</div>
					</div>
