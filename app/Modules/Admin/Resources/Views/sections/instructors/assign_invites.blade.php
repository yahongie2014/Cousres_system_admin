	...
	<div class="col-md-12">
		<div class="portlet box yellow">
			...
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<form action="{{ route('assignInvites', $id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-md-9">
	                          	<div class="form-group last">
		                            ...
		                            <div class="col-md-7">
			                            <select multiple="multiple" class="multi-select" id="my_multi_select2" name="module_instructors[]">
